...
echo -e "\n========= 1. 自动安装 3proxy =========\n"
apt update
DEBIAN_FRONTEND=noninteractive apt install -y gcc make git wget python3 python3-pip python3-venv sqlite3 cron
...
echo -e "\n如需卸载：bash <(curl -fsSL $SCRIPT_URL) uninstall"
echo -e "如需重装：bash <(curl -fsSL $SCRIPT_URL) reinstall"
